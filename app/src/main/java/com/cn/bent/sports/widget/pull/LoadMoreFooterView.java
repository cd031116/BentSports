package com.cn.bent.sports.widget.pull;
...
public class LoadMoreFooterView extends FrameLayout {
    ...
    public LoadMoreFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layout_hrecyclerview_load_more_footer_view, this, true);
